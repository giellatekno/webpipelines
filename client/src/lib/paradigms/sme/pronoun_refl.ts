            ...
            tables: [
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        { label: "su/dan", tags: ["Acc+PxSg3"], separator: true },
                        { label: "munno", tags: ["Acc+PxDu1"] },
                        { label: "dudno", tags: ["Acc+PxDu2"] },
                        { label: "sudno", tags: ["Acc+PxDu3"], separator: true },
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        { label: "su/dan", tags: ["Gen+PxSg3"], separator: true },
                        { label: "munno", tags: ["Gen+PxDu1"] },
                        { label: "dudno", tags: ["Gen+PxDu2"] },
                        { label: "sudno", tags: ["Gen+PxDu3"], separator: true },
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        { label: "sutnje/dasa", tags: ["Ill+PxSg3"], separator: true },
                        { label: "munnuide", tags: ["Ill+PxDu1"] },
                        { label: "dudnuide", tags: ["Ill+PxDu2"] },
                        { label: "sudnuide", tags: ["Ill+PxDu3"], separator: true },
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        { label: "sus/das", tags: ["Loc+PxSg3"], separator: true },
                        { label: "munnos", tags: ["Loc+PxDu1"] },
                        { label: "dudnos", tags: ["Loc+PxDu2"] },
                        { label: "sudnos", tags: ["Loc+PxDu3"], separator: true },
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        { label: "suinna/dainna", tags: ["Com+PxSg3"], separator: true },
                        { label: "munnuin", tags: ["Com+PxDu1"] },
                        { label: "dudnuin", tags: ["Com+PxDu2"] },
                        { label: "sudnuin", tags: ["Com+PxDu3"], separator: true },
                ...
                },
                {
                    ...
                    headers: [m.paradigm_person, m.paradigm_empty],
                    rows: [
                        { label: "Vaikko geanin", tags: ["Ess"], separator: true },
                        { label: "munin", tags: ["Ess+PxSg1"] },
                        { label: "dunin", tags: ["Ess+PxSg2"] },
                        { label: "sunin/danin", tags: ["Ess+PxSg3"], separator: true },
                        { label: "munnon", tags: ["Ess+PxDu1"] },
                        { label: "dudnon", tags: ["Ess+PxDu2"] },
                        { label: "sudnon", tags: ["Ess+PxDu3"], separator: true },
