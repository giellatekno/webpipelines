            ...
            tables: [
                {
                    ...
                    rows: [
                        ...
                        { label: "son/dat", tags: ["Ind+Sg3"], separator: true },
                        { label: "moai", tags: ["Ind+Du1"] },
                        { label: "doai", tags: ["Ind+Du2"] },
                        { label: "soai", tags: ["Ind+Du3"], separator: true },
            ...
            tables: [
                {
                    ...
                    rows: [
                        ...
                        { label: "son/dat", tags: ["Imprt+Sg3"], separator: true },
                        { label: "moai", tags: ["Imprt+Du1"] },
                        { label: "doai", tags: ["Imprt+Du2"] },
                        { label: "soai", tags: ["Imprt+Du3"], separator: true },
            ...
            tables: [
                {
                    ...
                    rows: [
                        ...
                        { label: "son/dat", tags: ["Sup+Sg3"], separator: true },
                        { label: "moai", tags: ["Sup+Du1"] },
                        { label: "doai", tags: ["Sup+Du2"] },
                        { label: "soai", tags: ["Sup+Du3"], separator: true },
