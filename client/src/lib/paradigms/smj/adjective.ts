            ...
            tables: [
                {
                    ...
                    rows: [
                        ...
                        { label: m.paradigm_inessive, tags: ["Der/Comp+A+Sg+Ine", "Der/Comp+A+Pl+Ine"] },
                        { label: m.paradigm_elative, tags: ["Der/Comp+A+Sg+Ela", "Der/Comp+A+Pl+Ela"] },
            ...
            tables: [
                {
                    ...
                    rows: [
                        ...
                        { label: m.paradigm_inessive, tags: ["Der/Superl+A+Sg+Ine", "Der/Superl+A+Pl+Ine"] },
                        { label: m.paradigm_elative, tags: ["Der/Superl+A+Sg+Ela", "Der/Superl+A+Pl+Ela"] },
